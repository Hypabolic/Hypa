...
public sealed class DotnetRewriteStrategy : ICommandRewriteStrategy
{
    private static readonly HashSet<string> Supported = ["build", "test"];

    public bool CanHandle(string verb) => verb == "dotnet";
